          ...
          <div className="sidebar-section">
            ...
            <ul className="read-history">
              {blogs.slice(0, 3).map((blog, index) => (
                <li key={index}>
                  <Link to={`/basic-user/blog/${blog.id}`}>
        ...
        <header className="blog-header">
          <div className="blog-header-container">
            <div className="blog-logo">
              <Link to="/basic-user/blog">Blog Spot.</Link>
            </div>
          ...
          <nav className={`blog-nav ${showMobileMenu ? 'show' : ''}`}>
            <ul>
              <li><Link to="/basic-user/blog">Articles <span>{blogs.length}</span></Link></li>
              <li><Link to="/basic-user/blog">Radio <span>18</span></Link></li>
              <li><Link to="/basic-user/blog">Podcast <span>49</span></Link></li>
              <li><Link to="/basic-user/blog">Be a writer</Link></li>
              <li><Link to="/basic-user/blog">Talk to us</Link></li>
            </ul>
          </nav>
        </header>
        ...
        <div className="blog-main">
          <div className="blog-section-header">
            ...
            <div className="blog-actions">
              <Link to="/basic-user/blog" className="view-all-link">
                See all posts →
              </Link>
              <Link to="/basic-user/blog" className="view-more-link">
                view more
              </Link>
            </div>
          </div>
              ...
              return (
                <div key={blog.id} className="blog-card">
                  <div className="blog-card-image">
                    ...
                    <Link to={`/basic-user/blog/${blog.id}`} className="blog-card-link">
                  ...
                  <div className="blog-card-content">
                    ...
                    <Link to={`/basic-user/blog/${blog.id}`} className="read-more-link">
                      Read more
                    </Link>
                  </div>
                </div>
