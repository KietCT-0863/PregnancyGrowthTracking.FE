      ...
      {isLoggedIn && isDropdownOpen && (
        <div className="user-dropdown">
          ...
          <div className="dropdown-menu">
            <Link
              to={`/basic-user/profile/view/${userInfo?.userId}`}
        ...
        <div className="horizontal-nav visible" ref={horizontalNavRef}>
          <div className="horizontal-nav-items">
            ...
            <Link
              to="/basic-user"
              className={`nav-item ${
                location.pathname === "/basic-user" ? "active" : ""
              }`}
              onClick={() => setShowHorizontalMenu(false)}
            >
            ...
            <Link
              to="/basic-user/blog"
              className={`nav-item ${
                location.pathname.includes("/basic-user/blog") ? "active" : ""
              }`}
              onClick={() => setShowHorizontalMenu(false)}
            >
            ...
            <Link
              ...
              className={`nav-item ${
                location.pathname.includes("/basic-user/community")
                  ? "active"
                  : ""
              }`}
              onClick={() => setShowHorizontalMenu(false)}
            ...
            <Link
              to="/basic-user/profile"
              className={`nav-item ${
                location.pathname.includes("/basic-user/profile")
                  ? "active"
                  : ""
              }`}
              onClick={() => setShowHorizontalMenu(false)}
